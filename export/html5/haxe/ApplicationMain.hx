...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AloneTogether", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AloneTogether", null, 960, 540);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "133";
		app.meta["company"] = "GeoKureli";
		app.meta["file"] = "AloneTogether";
		app.meta["name"] = "Alone Together";
